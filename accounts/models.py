...
class Profile(models.Model):
    ...
    email = models.EmailField(max_length=100, verbose_name='Почта', default='Почта')
    number_phone = models.CharField(max_length=12, verbose_name='Номер телефона', default='Номер телефона')
